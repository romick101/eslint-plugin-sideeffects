...
/**
 * code smells: 
 *  create function is huge
 *  prediactes need to be lifted to separate module
 *  node processing functions are split between rules
 */
    ...
    create(context) {
        ...
        function checkLastSegment(node) {
            if (node.type === 'ArrowFunctionExpression' &&
                ...
                return;
            if (funcInfo.node.parent.kind !== 'constructor' &&
